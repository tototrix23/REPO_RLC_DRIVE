 ...
 * Functions
 **********************************************************************************************************************/
extern motor_120_driver_instance_ctrl_t g_mot_120_driver0_ctrl;
extern motor_120_driver_instance_ctrl_t g_mot_120_driver1_ctrl;
/*******************************************************************************************************************//**
...
fsp_err_t RM_MOTOR_120_DRIVER_Open (motor_120_driver_ctrl_t * const p_ctrl, motor_120_driver_cfg_t const * const p_cfg)
{
    ...
    /*if(p_ctrl == &g_motor_120_driver1_ctrl)
        {
...
static void rm_motor_120_driver_current_get (motor_120_driver_instance_ctrl_t * p_ctrl)
{
    static uint16_t u2_addata[6] = {0U};
...
void rm_motor_120_driver_cyclic (adc_callback_args_t * p_args)
{
    ...
    if(p_args->event == ADC_EVENT_CALIBRATION_COMPLETE || p_args->event == ADC_EVENT_CALIBRATION_REQUEST)
    {
        return;
    }
    else if(p_args->event ==ADC_EVENT_SCAN_COMPLETE)
    {
